...
# **vehicles_list**
> PaginatedExternalAPIVehicleList vehicles_list(limit=limit, offset=offset, raw_id__gt=raw_id__gt)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Querying of vehicles
        api_response = api_instance.vehicles_list(limit=limit, offset=offset, raw_id__gt=raw_id__gt)
