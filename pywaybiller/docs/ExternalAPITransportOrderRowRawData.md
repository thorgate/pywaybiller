...
------------ | ------------- | ------------- | -------------
**destination_id** | **int** | Unique identifier of the destination in Waybiller | [readonly] 
**assortment_id** | **int** | Unique identifier of the assortment in Waybiller | [readonly] 
