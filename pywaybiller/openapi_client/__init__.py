...
from pywaybiller.openapi_client.models.scale_reading_in_reading_pair_source import (
    ScaleReadingInReadingPairSource,
)
from pywaybiller.openapi_client.models.source_enum import SourceEnum
