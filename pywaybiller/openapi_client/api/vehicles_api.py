...
class VehiclesApi:
    ...
    def vehicles_list(
        ...
        **kwargs
    ) -> VehiclesList200Response:  # noqa: E501
        """Querying of vehicles  # noqa: E501

        Returns all vehicles associated with your company and with your subcontractors.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.vehicles_list(limit, offset, async_req=True)
        >>> result = thread.get()
        ...
        :rtype: VehiclesList200Response
        """
        kwargs["_return_http_data_only"] = True
        if "_preload_content" in kwargs:
            message = "Error! Please call the vehicles_list_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.vehicles_list_with_http_info(limit, offset, **kwargs)  # noqa: E501
    ...
    def vehicles_list_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.vehicles_list_with_http_info(limit, offset, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(VehiclesList200Response, status_code(int), headers(HTTPHeaderDict))
        """
