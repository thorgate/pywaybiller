...
class WaybillsList200Response(BaseModel):
    """
    ...
    results: conlist(ExternalAPIWaybillList) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WaybillsList200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WaybillsList200Response:
        """Create an instance of WaybillsList200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WaybillsList200Response.parse_obj(obj)

        _obj = WaybillsList200Response.parse_obj(
            {
                "count": obj.get("count"),
                "next": obj.get("next"),
                "previous": obj.get("previous"),
                "results": [
                    ExternalAPIWaybillList.from_dict(_item)
