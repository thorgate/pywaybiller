...
class ExternalAPIWaybillRowAcceptedAmountRequest(BaseModel):
    """
    ...
    accepted_assortment_id: Optional[StrictInt] = Field(
        default=None,
    ...
    @field_validator("accepted_gross_weight")
    def accepted_gross_weight_validate_regular_expression(cls, value):
    ...
    @field_validator("accepted_tare_weight")
    def accepted_tare_weight_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
