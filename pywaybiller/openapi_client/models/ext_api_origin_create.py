...
class ExtAPIOriginCreate(BaseModel):
    """
    ExtAPIOriginCreate
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExtAPIOriginCreate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExtAPIOriginCreate:
        """Create an instance of ExtAPIOriginCreate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExtAPIOriginCreate.parse_obj(obj)

        _obj = ExtAPIOriginCreate.parse_obj(
            {
                "id": obj.get("id"),
                "name": obj.get("name"),
