...
class ExternalAPIHoldingBaseRequest(BaseModel):
    """
    ...
    contract_date: Optional[
        Annotated[str, Field(min_length=1, strict=True, max_length=32)]
    ] = Field(default=None, alias="contractDate")
    previous_owner: Optional[ExternalAPIHoldingBasePreviousOwnerRequest] = Field(
        ...
        _obj = cls.model_validate(
            {
                ...
                "previousOwner": ExternalAPIHoldingBasePreviousOwnerRequest.from_dict(
                    obj["previousOwner"]
                )
