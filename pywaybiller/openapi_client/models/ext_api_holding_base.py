...
class ExtAPIHoldingBase(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in (
            ...
            raise ValueError(
                "must be one of enum values ('ForestNotice', 'InventoryAct', 'ConsolidatedAct', 'ForestAct', 'SalesContract', 'ContractForTransferOfCuttingRights')"
            )
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExtAPIHoldingBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExtAPIHoldingBase:
        """Create an instance of ExtAPIHoldingBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExtAPIHoldingBase.parse_obj(obj)

        _obj = ExtAPIHoldingBase.parse_obj(
            {
                "type": obj.get("type"),
