...
class ExternalAPIWaybillHoldingRightRequest(BaseModel):
    """
    ExternalAPIWaybillHoldingRightRequest
    """  # noqa: E501

    cadaster_number: Annotated[
        str, Field(min_length=1, strict=True, max_length=500)
    ] = Field(description="Cadaster number.")
    forest_notices: Optional[List[Annotated[str, Field(min_length=1, strict=True)]]] = (
        Field(default=None, description="Origin forest notices.")
    )
    __properties: ClassVar[List[str]] = ["cadaster_number", "forest_notices"]
        ...
        _obj = cls.model_validate(
            {
                ...
                "forest_notices": obj.get("forest_notices"),
            }
        )
        return _obj
