...
class ExternalAPIWaybillRawData(BaseModel):
    ...
    waybill_id: Optional[StrictInt] = Field(None, description="The ID of the waybill.")
    truck_id: Optional[StrictInt] = Field(None, description="The ID of the truck.")
    driver_user_id: Optional[StrictInt] = Field(
        None, description="The ID of the driver."
    )
    origin_id: Optional[StrictInt] = None
    destination_id: Optional[StrictInt] = Field(
        None, description="The ID of the destination."
    )
    rows: Optional[conlist(ExternalAPIWaybillRowRawData)] = Field(
        None, description="Waybill rows."
    )
    user_defined_fields: Optional[Dict[str, Any]] = Field(
        None, description="User defined fields."
    )
    __properties = [
        "waybill_id",
        "truck_id",
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExternalAPIWaybillRawData:
    ...
    def to_dict(self):
        ...
        if self.driver_user_id is None and "driver_user_id" in self.__fields_set__:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExternalAPIWaybillRawData:
        """Create an instance of ExternalAPIWaybillRawData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExternalAPIWaybillRawData.parse_obj(obj)

        _obj = ExternalAPIWaybillRawData.parse_obj(
            {
