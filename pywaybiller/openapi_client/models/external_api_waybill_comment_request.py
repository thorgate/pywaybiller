...
class ExternalAPIWaybillCommentRequest(BaseModel):
    """
    ...
    comment: Annotated[str, Field(min_length=1, strict=True)] = Field(
        description="Text of the comment."
    )
    __properties: ClassVar[List[str]] = ["comment_by_user_id", "comment"]
