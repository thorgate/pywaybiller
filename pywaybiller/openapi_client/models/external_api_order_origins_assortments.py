...
class ExternalAPIOrderOriginsAssortments(BaseModel):
    """
    Origin's assortments.  # noqa: E501
    """

    origin_assortment_raw_id: Optional[constr(strict=True, min_length=1)] = Field(
        None, description="Origin assortment raw id."
    )
    assortment_name: Optional[constr(strict=True, min_length=1)] = Field(
        None, description="Origin assortment name with subset value (if exists)."
    )
    __properties = ["origin_assortment_raw_id", "assortment_name"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExternalAPIOrderOriginsAssortments:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExternalAPIOrderOriginsAssortments:
        """Create an instance of ExternalAPIOrderOriginsAssortments from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExternalAPIOrderOriginsAssortments.parse_obj(obj)

        _obj = ExternalAPIOrderOriginsAssortments.parse_obj(
            {
                "origin_assortment_raw_id": obj.get("origin_assortment_raw_id"),
