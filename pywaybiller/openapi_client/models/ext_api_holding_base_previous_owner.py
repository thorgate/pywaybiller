...
class ExtAPIHoldingBasePreviousOwner(BaseModel):
    """
    ExtAPIHoldingBasePreviousOwner
    """

    name: constr(strict=True, max_length=64, min_length=1) = Field(...)
    code: constr(strict=True, max_length=64, min_length=1) = Field(...)
    address: constr(strict=True, max_length=64, min_length=1) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExtAPIHoldingBasePreviousOwner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExtAPIHoldingBasePreviousOwner:
        """Create an instance of ExtAPIHoldingBasePreviousOwner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExtAPIHoldingBasePreviousOwner.parse_obj(obj)

        _obj = ExtAPIHoldingBasePreviousOwner.parse_obj(
            {
                "name": obj.get("name"),
                "code": obj.get("code"),
