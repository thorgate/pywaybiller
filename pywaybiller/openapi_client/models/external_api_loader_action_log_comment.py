...
class ExternalAPILoaderActionLogComment(BaseModel):
    ...
    author_name: constr(strict=True, max_length=255, min_length=1) = Field(...)
    author_company_name: constr(strict=True, max_length=64, min_length=1) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExternalAPILoaderActionLogComment:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExternalAPILoaderActionLogComment:
        """Create an instance of ExternalAPILoaderActionLogComment from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExternalAPILoaderActionLogComment.parse_obj(obj)

        _obj = ExternalAPILoaderActionLogComment.parse_obj(
            {
