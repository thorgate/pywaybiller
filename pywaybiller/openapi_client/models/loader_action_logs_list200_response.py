...
class LoaderActionLogsList200Response(BaseModel):
    """
    ...
    results: conlist(ExternalAPILoaderActionLog) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LoaderActionLogsList200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LoaderActionLogsList200Response:
        """Create an instance of LoaderActionLogsList200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LoaderActionLogsList200Response.parse_obj(obj)

        _obj = LoaderActionLogsList200Response.parse_obj(
            {
                "count": obj.get("count"),
                "next": obj.get("next"),
