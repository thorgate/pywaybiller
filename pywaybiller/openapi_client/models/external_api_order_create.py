...
class ExternalAPIOrderCreate(BaseModel):
    ...
    period: conlist(date, max_items=2, min_items=2) = Field(
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExternalAPIOrderCreate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExternalAPIOrderCreate:
        """Create an instance of ExternalAPIOrderCreate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExternalAPIOrderCreate.parse_obj(obj)

        _obj = ExternalAPIOrderCreate.parse_obj(
            {
