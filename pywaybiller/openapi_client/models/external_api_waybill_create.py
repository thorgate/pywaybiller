...
class ExternalAPIWaybillCreate(BaseModel):
    ...
    waybill_id: constr(strict=True, min_length=1) = Field(
        ...,
    ...
    destination_address: Optional[constr(strict=True, min_length=1)] = Field(
    ...
    ] = Field(None, description="Cadaster number.")
    dispatcher_name: Optional[constr(strict=True, max_length=255)] = None
    dispatcher_phone: Optional[constr(strict=True, max_length=128)] = None
    shipper_company_name: Optional[
        constr(strict=True, max_length=64, min_length=1)
    ] = Field(None, description="The name of the shipper company.")
    shipper_company_reg_code: Optional[
        constr(strict=True, max_length=16, min_length=1)
    ] = Field(None, description="The registry code of the shipper company.")
    transportation_company_name: constr(
        strict=True, max_length=64, min_length=1
    ) = Field(..., description="The name of the transportation company.")
    transportation_company_reg_code: constr(
        strict=True, max_length=16, min_length=1
    ...
    confirmed_by_name: Optional[constr(strict=True, min_length=1)] = None
    confirmed_by_phone: Optional[constr(strict=True, min_length=1)] = None
    cancelled_by_email: Optional[
        constr(strict=True, max_length=255, min_length=1)
    ] = Field(
        None, description="The e-mail address of the user that cancelled the waybill."
    )
    cancelled_by_name: Optional[constr(strict=True, min_length=1)] = None
    cancelled_by_phone: Optional[constr(strict=True, min_length=1)] = None
    cancelling_reason: Optional[constr(strict=True, min_length=1)] = None
    ...
    navision_bin_code: Optional[constr(strict=True, min_length=1)] = Field(
        None, description="Bin code."
    )
    evr_waybill_number: Optional[constr(strict=True, min_length=1)] = Field(
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExternalAPIWaybillCreate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExternalAPIWaybillCreate:
        """Create an instance of ExternalAPIWaybillCreate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExternalAPIWaybillCreate.parse_obj(obj)

        _obj = ExternalAPIWaybillCreate.parse_obj(
            {
