...
class ExternalAPIOriginUpdate(BaseModel):
    """
    ...
    name: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(
        default=None, description="Name of the origin"
    )
    location: Optional[ExternalAPIOriginLocation] = Field(
        default=None, description="Physical location of the origin"
    )
    assortments: Optional[List[ExternalAPIOriginAssortment]] = Field(
