...
class ExternalAPIOrderTransportCompanies(BaseModel):
    """
    The transportation companies the client is using for transporting assortments from origins to destination.  # noqa: E501
    """

    transportation_company_name: Optional[
        constr(strict=True, max_length=64, min_length=1)
    ] = Field(None, description="Transportation company name.")
    transportation_company_reg_code: Optional[
        constr(strict=True, max_length=16, min_length=1)
    ] = Field(None, description="Transportation company reg code.")
    __properties = ["transportation_company_name", "transportation_company_reg_code"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExternalAPIOrderTransportCompanies:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExternalAPIOrderTransportCompanies:
        """Create an instance of ExternalAPIOrderTransportCompanies from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExternalAPIOrderTransportCompanies.parse_obj(obj)

        _obj = ExternalAPIOrderTransportCompanies.parse_obj(
            {
