...
class ExternalAPIWaybillRowRawData(BaseModel):
    ...
    assortment_id: Optional[StrictInt] = None
    subset_id: Optional[StrictInt] = None
    subset_type_id: Optional[StrictInt] = None
    __properties = ["assortment_id", "subset_id", "subset_type_id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExternalAPIWaybillRowRawData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExternalAPIWaybillRowRawData:
        """Create an instance of ExternalAPIWaybillRowRawData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExternalAPIWaybillRowRawData.parse_obj(obj)

        _obj = ExternalAPIWaybillRowRawData.parse_obj(
            {
