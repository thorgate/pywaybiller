...
class ExternalAPIPartialOrderUpdate(BaseModel):
    """
    ...
    __properties = ["transportation_companies", "vehicles"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExternalAPIPartialOrderUpdate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExternalAPIPartialOrderUpdate:
        """Create an instance of ExternalAPIPartialOrderUpdate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExternalAPIPartialOrderUpdate.parse_obj(obj)

        _obj = ExternalAPIPartialOrderUpdate.parse_obj(
            {
