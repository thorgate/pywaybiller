...
class ExternalAPIWaybillRowList(BaseModel):
    ...
    assortment_id: Optional[constr(strict=True, min_length=1)] = Field(
        None, description="The ID of the assortment."
    )
    assortment_ids: Optional[
        conlist(constr(strict=True, max_length=8, min_length=1))
    ] = Field(None, description="The IDs of the assortments.")
    assortment_name: Optional[constr(strict=True, min_length=1)] = Field(
        None, description="The name of the assortment."
    )
    __properties = ["assortment_id", "assortment_ids", "assortment_name"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExternalAPIWaybillRowList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExternalAPIWaybillRowList:
        """Create an instance of ExternalAPIWaybillRowList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExternalAPIWaybillRowList.parse_obj(obj)

        _obj = ExternalAPIWaybillRowList.parse_obj(
            {
