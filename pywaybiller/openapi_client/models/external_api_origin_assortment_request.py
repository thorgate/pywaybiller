...
class ExternalAPIOriginAssortmentRequest(BaseModel):
    """
    ExternalAPIOriginAssortmentRequest
    """  # noqa: E501

    id: StrictInt = Field(description="Assortment ID")
    subsets: Optional[List[StrictInt]] = Field(
        default=None, description="List of subset IDs"
    )
    __properties: ClassVar[List[str]] = ["id", "subsets"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"id": obj.get("id"), "subsets": obj.get("subsets")})
        return _obj
