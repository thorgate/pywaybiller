...
class ExternalAPITransportOrderRowRawData(BaseModel):
    """
    ExternalAPITransportOrderRowRawData
    """

    assortment_id: Optional[StrictStr] = None
    __properties = ["assortment_id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExternalAPITransportOrderRowRawData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExternalAPITransportOrderRowRawData:
        """Create an instance of ExternalAPITransportOrderRowRawData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExternalAPITransportOrderRowRawData.parse_obj(obj)

        _obj = ExternalAPITransportOrderRowRawData.parse_obj(
