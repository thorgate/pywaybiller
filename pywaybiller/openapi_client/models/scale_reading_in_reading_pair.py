...
class ScaleReadingInReadingPair(BaseModel):
    """
    ...
    source: Optional[ScaleReadingInReadingPairSource] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "source": ScaleReadingInReadingPairSource.from_dict(obj["source"])
