...
class ExtAPIOriginUpdate(BaseModel):
    """
    ExtAPIOriginUpdate
    """
    ...
    assortments: Optional[conlist(ExtAPIOriginAssortment)] = None
    ...
    holding_base: Optional[ExtAPIHoldingBase] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExtAPIOriginUpdate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExtAPIOriginUpdate:
        """Create an instance of ExtAPIOriginUpdate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExtAPIOriginUpdate.parse_obj(obj)

        _obj = ExtAPIOriginUpdate.parse_obj(
            {
                "id": obj.get("id"),
                "name": obj.get("name"),
                ...
                "holding_base": ExtAPIHoldingBase.from_dict(obj.get("holding_base"))
