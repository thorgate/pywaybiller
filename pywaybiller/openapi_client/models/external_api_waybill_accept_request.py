...
class ExternalAPIWaybillAcceptRequest(BaseModel):
    """
    ...
    accepted_amounts: List[ExternalAPIWaybillRowAcceptedAmountRequest] = Field(
        ...
        _obj = cls.model_validate(
            {
                ...
                "accepted_amounts": [
                    ExternalAPIWaybillRowAcceptedAmountRequest.from_dict(_item)
