...
class TransportOrdersList200Response(BaseModel):
    """
    ...
    results: conlist(ExternalAPITransportOrderList) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TransportOrdersList200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TransportOrdersList200Response:
        """Create an instance of TransportOrdersList200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TransportOrdersList200Response.parse_obj(obj)

        _obj = TransportOrdersList200Response.parse_obj(
            {
                "count": obj.get("count"),
                "next": obj.get("next"),
