...
class ExternalAPIDestination(BaseModel):
    """
    ...
    longitude: Union[StrictFloat, StrictInt] = Field(
        description="Longitude coordinate of the destination's location"
    )
    ...
    owner_reg_code: Annotated[str, Field(min_length=1, strict=True, max_length=16)] = (
        Field(description="Registration code of the destination's owner company")
    )
    raw_data: ExternalAPIDestinationRawData = Field(
        ...
        _obj = cls.model_validate(
            {
                ...
                "raw_data": ExternalAPIDestinationRawData.from_dict(obj["raw_data"])
