...
class ExternalAPIWaybillRawDataList(BaseModel):
    """
    ...
    __properties = ["waybill_id", "destination_id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExternalAPIWaybillRawDataList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExternalAPIWaybillRawDataList:
        """Create an instance of ExternalAPIWaybillRawDataList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExternalAPIWaybillRawDataList.parse_obj(obj)

        _obj = ExternalAPIWaybillRawDataList.parse_obj(
            {
