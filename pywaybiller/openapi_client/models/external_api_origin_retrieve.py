...
class ExternalAPIOriginRetrieve(BaseModel):
    """
    ...
    partner_companies: List[StrictStr] = Field(
        description="List of registry codes of partner companies"
    )
    ...
    holding_base: ExternalAPIHoldingBase = Field(
    ...
    extra_information: Annotated[str, Field(strict=True, max_length=254)] = Field(
        description="Additional information about the origin that doesn't fit in other fields"
    )
    representative_name: Annotated[str, Field(strict=True, max_length=64)] = Field(
        description="Name of the person representing this origin"
    )
    representative_phone: Annotated[str, Field(strict=True, max_length=128)] = Field(
        description="Contact phone number for the origin representative"
    )
    ...
    feature_single_transport_order_per_truck: StrictBool = Field(
    ...
    feature_waybill_dispatched_amounts_changing_disabled: StrictBool = Field(
        description="Drivers and receivers are not allowed to change dispatched amounts for waybills from this origin"
    )
    feature_waybill_destination_changing_disabled_for_drivers: StrictBool = Field(
        description="Drivers are not allowed to change the destination of waybills from this origin"
    )
    company: StrictStr = Field(description="Registry code of the owner company")
        ...
        _obj = cls.model_validate(
            {
                ...
                "holding_base": ExternalAPIHoldingBase.from_dict(obj["holding_base"])
                ...
                "waybill_created_emails_language": ExternalAPIOriginRetrieveWaybillCreatedEmailsLanguage.from_dict(
                    obj["waybill_created_emails_language"]
                )
                if obj.get("waybill_created_emails_language") is not None
                else None,
                "waybill_accepted_emails_language": ExternalAPIOriginRetrieveWaybillCreatedEmailsLanguage.from_dict(
                    obj["waybill_accepted_emails_language"]
                )
                if obj.get("waybill_accepted_emails_language") is not None
                else None,
                "waybill_reached_destination_emails_language": ExternalAPIOriginRetrieveWaybillCreatedEmailsLanguage.from_dict(
                    obj["waybill_reached_destination_emails_language"]
                )
                if obj.get("waybill_reached_destination_emails_language") is not None
                else None,
                "transport_order_created_emails_language": ExternalAPIOriginRetrieveWaybillCreatedEmailsLanguage.from_dict(
