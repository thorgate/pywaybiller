...
class ExternalAPIRawSerializer(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExternalAPIRawSerializer:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExternalAPIRawSerializer:
        """Create an instance of ExternalAPIRawSerializer from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExternalAPIRawSerializer.parse_obj(obj)

        _obj = ExternalAPIRawSerializer.parse_obj({"id": obj.get("id")})
        return _obj
