...
class OriginsList200Response(BaseModel):
    """
    ...
    results: conlist(ExtAPIOriginList) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OriginsList200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OriginsList200Response:
        """Create an instance of OriginsList200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OriginsList200Response.parse_obj(obj)

        _obj = OriginsList200Response.parse_obj(
            {
                "count": obj.get("count"),
                "next": obj.get("next"),
                "previous": obj.get("previous"),
                "results": [
                    ExtAPIOriginList.from_dict(_item) for _item in obj.get("results")
                ]
