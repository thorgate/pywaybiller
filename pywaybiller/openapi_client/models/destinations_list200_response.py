...
class DestinationsList200Response(BaseModel):
    """
    ...
    results: conlist(ExtAPIDestination) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DestinationsList200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DestinationsList200Response:
        """Create an instance of DestinationsList200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DestinationsList200Response.parse_obj(obj)

        _obj = DestinationsList200Response.parse_obj(
            {
                "count": obj.get("count"),
                "next": obj.get("next"),
                "previous": obj.get("previous"),
                "results": [
                    ExtAPIDestination.from_dict(_item) for _item in obj.get("results")
                ]
