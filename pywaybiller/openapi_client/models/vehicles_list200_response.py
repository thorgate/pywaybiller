...
class VehiclesList200Response(BaseModel):
    """
    ...
    results: conlist(ExternalAPIVehicle) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VehiclesList200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VehiclesList200Response:
        """Create an instance of VehiclesList200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VehiclesList200Response.parse_obj(obj)

        _obj = VehiclesList200Response.parse_obj(
            {
                "count": obj.get("count"),
                "next": obj.get("next"),
                "previous": obj.get("previous"),
                "results": [
                    ExternalAPIVehicle.from_dict(_item) for _item in obj.get("results")
                ]
