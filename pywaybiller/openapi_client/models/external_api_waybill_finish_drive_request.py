...
class ExternalAPIWaybillFinishDriveRequest(BaseModel):
    """
    ExternalAPIWaybillFinishDriveRequest
    """  # noqa: E501

    kilometres: Annotated[int, Field(le=999, strict=True, ge=1)] = Field(
        description="Total mileage driven (in kilometres)."
    )
    __properties: ClassVar[List[str]] = ["kilometres"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"kilometres": obj.get("kilometres")})
        return _obj
