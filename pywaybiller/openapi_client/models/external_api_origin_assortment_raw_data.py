...
class ExternalAPIOriginAssortmentRawData(BaseModel):
    """
    ...
    assortment_id: StrictInt = Field(description="Unique identifier of the assortment")
    subset_type_id: Optional[StrictInt] = Field(
        description="Unique identifier of the subset type that categorizes the assortment"
    )
    subset_id: Optional[StrictInt] = Field(
        description="Unique identifier of the assortment subset"
    )
