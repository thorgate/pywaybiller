...
class ExternalAPIWaybillVehicleLocation(BaseModel):
    ...
    latitude: Optional[Union[StrictFloat, StrictInt]] = Field(
        None, description="The latitude coordinate of the vehicle (eg 59.401034)."
    )
    longitude: Optional[Union[StrictFloat, StrictInt]] = Field(
        None, description="The longitude coordinate of the vehicle (eg 24.791717)."
    )
    location_timestamp: Optional[constr(strict=True, min_length=1)] = Field(
        None,
        description="UTC timestamp when vehicle was in that position (eg 2020-05-08T19:06:33).",
    )
    __properties = ["latitude", "longitude", "location_timestamp"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExternalAPIWaybillVehicleLocation:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExternalAPIWaybillVehicleLocation:
        """Create an instance of ExternalAPIWaybillVehicleLocation from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExternalAPIWaybillVehicleLocation.parse_obj(obj)

        _obj = ExternalAPIWaybillVehicleLocation.parse_obj(
            {
