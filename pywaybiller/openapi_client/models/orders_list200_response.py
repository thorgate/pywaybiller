...
class OrdersList200Response(BaseModel):
    """
    ...
    results: conlist(ExternalAPIOrderList) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OrdersList200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OrdersList200Response:
        """Create an instance of OrdersList200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OrdersList200Response.parse_obj(obj)

        _obj = OrdersList200Response.parse_obj(
            {
                "count": obj.get("count"),
                "next": obj.get("next"),
                "previous": obj.get("previous"),
                "results": [
                    ExternalAPIOrderList.from_dict(_item)
