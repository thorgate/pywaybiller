...
class VehicleLocationDataList200Response(BaseModel):
    """
    ...
    results: conlist(ExternalAPIVehicleLocationData) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VehicleLocationDataList200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VehicleLocationDataList200Response:
        """Create an instance of VehicleLocationDataList200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VehicleLocationDataList200Response.parse_obj(obj)

        _obj = VehicleLocationDataList200Response.parse_obj(
            {
                "count": obj.get("count"),
                "next": obj.get("next"),
                "previous": obj.get("previous"),
                "results": [
                    ExternalAPIVehicleLocationData.from_dict(_item)
