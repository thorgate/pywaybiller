...
class ExternalAPIHoldingBasePreviousOwner(BaseModel):
    """
    ExternalAPIHoldingBasePreviousOwner
    """  # noqa: E501

    name: Annotated[str, Field(strict=True, max_length=64)]
    code: Annotated[str, Field(strict=True, max_length=64)]
    address: Annotated[str, Field(strict=True, max_length=64)]
    __properties: ClassVar[List[str]] = ["name", "code", "address"]
