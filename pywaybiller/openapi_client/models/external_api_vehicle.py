...
class ExternalAPIVehicle(BaseModel):
    ...
    reg_number: Annotated[str, Field(strict=True, max_length=16)] = Field(
    ...
    inactive: StrictBool = Field(
        description="Indicates if the vehicle has been deactivated"
    )
    company_name: Annotated[str, Field(min_length=1, strict=True, max_length=64)] = (
        Field(description="Name of the company owning the vehicle")
    )
    company_reg_code: Annotated[
        str, Field(min_length=1, strict=True, max_length=16)
    ] = Field(description="Registration code of the company owning the vehicle")
