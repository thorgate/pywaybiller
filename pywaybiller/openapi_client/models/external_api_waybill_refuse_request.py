...
class ExternalAPIWaybillRefuseRequest(BaseModel):
    """
    ExternalAPIWaybillRefuseRequest
    """  # noqa: E501

    reason: Annotated[str, Field(min_length=1, strict=True)] = Field(
        description="Reason for refusal."
    )
    destination_raw_id: Optional[StrictStr] = Field(
        default=None, description="The ID of the new destination."
    )
    __properties: ClassVar[List[str]] = ["reason", "destination_raw_id"]
